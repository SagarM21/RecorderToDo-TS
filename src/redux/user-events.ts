...
const LOAD_REQUEST = "user-events/load_request";

interface LoadRequestAction extends Action<typeof LOAD_REQUEST> {}

const LOAD_SUCCESS = "user-events/load_success";
...
const LOAD_FAILURE = "user-events/load_failure";
...
const DELETE_FAILURE = "userEvents/delete_success";
...
export default userEventReudcer;
